...
+ "`" +((enStr))+ "` varchar(255) DEFAULT NULL COMMENT '" +((chStr))+ "',"
    	...
    	String doSql = ""+/**~!{*/""
    		+ "CREATE TABLE `" +((enTableName))+ "` ("
				...
				+ "\r\n`identificationDate` timestamp NULL DEFAULT NULL COMMENT '排查日期',"
				+ "\r\n`coalMineName` varchar(255) DEFAULT NULL COMMENT '数据所属煤矿',"
				+ "\r\n`reservedField1` varchar(255) DEFAULT NULL COMMENT '预留字段a',"
