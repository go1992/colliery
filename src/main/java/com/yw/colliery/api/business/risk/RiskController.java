...
import com.yw.colliery.service.risk.ControlRecordService;
...
@Slf4j
public class RiskController extends BaseController<RiskServiceImpl, AqfxNdfx> {
    ...
    public Object updateById(AqfxNdfx params) {
        ...
        if (!old.getGkcs().equals(params.getGkcs())) {
            ...
            controlRecordService.save(oldSave);
        }
